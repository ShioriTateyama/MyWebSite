...
/**
 * Servlet implementation class ItemPriceOrderServlet
 */
@WebServlet("/ItemPriceOrderServlet")
public class ItemPriceOrderServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ItemPriceOrderServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(categoryId==3) {
					...
					List<ItemDetailBeans> bathrobeList= itemDetailDao.getBathrobeDataByPrice();
			...
			List<ItemDetailBeans> itemDataList =itemDetailDao.getItemByCategoryByPrice(categoryId) ;
