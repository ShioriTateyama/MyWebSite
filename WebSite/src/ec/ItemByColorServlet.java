...
/**
 * Servlet implementation class ItemByColorServlet
 */
@WebServlet("/ItemByColorServlet")
public class ItemByColorServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ItemByColorServlet() {
        super();
...
if(categoryId==3) {
			...
			List<ItemDetailBeans> bathrobeList= itemDetailDao.getBathrobeDataByColorId(colorId);
	...
	List<ItemDetailBeans> itemDataList =itemDetailDao.getItemByColorIdAndColorId(categoryId,colorId) ;
