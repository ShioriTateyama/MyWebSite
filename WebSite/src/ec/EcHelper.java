...
public class EcHelper {
	 ...
	 * @return total
	 */
	public static int getTotalItemPrice(ArrayList<ItemDetailBeans> items) {
		int total = 0;
		for (ItemDetailBeans item : items) {
			total += item.getPrice()*item.getQuantity();
		}
		return total;
	}

	public static int getTotalItemQuantity(ArrayList<ItemDetailBeans> items) {
		int total = 0;
		for (ItemDetailBeans item : items) {
