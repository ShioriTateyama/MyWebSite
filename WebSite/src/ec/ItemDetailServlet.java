...
public class ItemDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ItemDetailBeans itemData = itemDetailDao.selectItemDetailDatabyItemDetailId(itemDetailId);
			...
			if(session.getAttribute("loginUser")!= null ) {
				...
				List<FavoriteBeans>  favoriteList = favoriteDAO.getAllFavoriteData(ub.getUserId());
					...
					for (FavoriteBeans FavoriteBeans : favoriteList) {
						int favoriteItemDetailId=FavoriteBeans.getItemDetailId();

							if(favoriteItemDetailId==itemDetailId) {
